...
@section('title', 'Inicio sesión | 3KLeague')
@section('navigation')
...
@section('banner')
    <x-banner>
        ...
        <x-slot name='subtitle'>
            Accede a tu área privada y empieza a gestionar tu entidad
        </x-slot>
    </x-banner>
@endsection
            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4">
                    <div class="wow fadeInUp relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white py-14 px-8 text-center sm:px-12 md:px-[60px]"
                        ...
                        <form id="signin-form" action="{{ route('entity.index') }}" method="POST">
                            <div class="mb-6">
