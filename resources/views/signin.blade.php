            ...
            <div class="w-full px-4">
                <div class="mb-12 max-w-[620px] lg:mb-20">
                    ...
                    <p class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
                        In the initial and free version of the website you will be able to manage a 3X3 basketball
                        league. You will manage the teams, the matches and the results.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="items-center justify-between overflow-hidden border lg:flex">
                        <div
                            ...
                            <h2 class="mb-6 text-3xl font-bold text-dark sm:text-4xl sm:leading-snug 2xl:text-[40px]">
                                Brilliant Toolkit to Manage 3X3 Basketball League Faster.
                            </h2>
                            <p class="mb-9 text-base leading-relaxed text-body-color">
                                The main intention is to focus on the league and reduce all the most tedious but
                                essential procedures for it to be carried out.
                            </p>
                            <p class="mb-9 text-base leading-relaxed text-body-color">
        ...
        <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4">
                <div class="mx-auto mb-[60px] max-w-[620px] text-center">
                    ...
                    <p class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
                        Find out the results and know the leagues that are available.
                    </p>
                </div>
            </div>
        </div>
