                ...
                <div class="w-full px-4">
                    <div class="mb-12 max-w-[620px] lg:mb-20">
                        ...
                        <p class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
                            En la versión inicial y gratuita de la web podrás gestionar una liga 3X3 de baloncesto.
                            Tendrás control tanto de los equipos, jugadores y árbitros, como de los partidos y resultados.s
                    </div>
                </div>
                <div class="-mx-4 flex flex-wrap">
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                        <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s">
                            ...
                            <p class="mb-8 text-body-color lg:mb-11">
                                (Próximamente) Lorem Ipsum is simply dummy text of the printing and industry.
                            </p>
                        ...
                        <div class="items-center justify-between overflow-hidden border lg:flex">
                            <div
                                ...
                                <p class="mb-9 text-base leading-relaxed text-body-color">
                                    ...
                                    magni. Repellendus, tempore! Excepturi magni, atque architecto nisi, unde iure facere,
                                    molestiae adipisci tempore officiis ullam error dolorum! Lorem ipsum, dolor sit amet
                            ...
                            <div class="text-center">
                                <div class="relative z-10 inline-block">
                                    <img src="{{ Vite::asset('resources/images/about/about-image.svg') }}" alt="image"
        ...
        <div class="container">
            ...
            <div class="-mx-4 flex flex-wrap justify-center">
                <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp mb-10" data-wow-delay=".1s">
                        <div class="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                            <img src="{{ Vite::asset('resources/images/team/team-01.png') }}" alt="image"
                                class="w-full rounded-full" />
                            <span class="absolute top-0 left-0 z-[-1]">
                                @php
                                    $figure = '<svg width="71" height="82" viewBox="0 0 71 82" fill="none" xmlns="http://www.w3.org/2000/svg">';
                                    for ($j = 0; $j < 250; $j += 10) {
                                        for ($i = 0; $i < 200; $i += 10) {
                                            $figure .= '<circle cx="' . $j . '" cy="' . $i . '" r="1" transform="rotate(-90 1.66667 104)" fill="#793BF2" />';
                                        }
                                    }
                                    $figure .= '</svg>';
                                    echo $figure;
                        ...
                        <div class="text-center text-sm">
                            ...
                            <a href="https://goo.gl/maps/2SX5DS81axL4UPH9A" class="text-body-color hover:text-primary">
                                <p class="font-medium">
                                    Avinguda del Doctor Bassols, 0, 08911 Badalona, Barcelona
                                </p>
                            </a>
                        </div>
                    </div>
        ...
        <div class="container px-4">
            <div class="-mx-4 flex flex-wrap items-center">
                    ...
                    <div class="ud-contact-content-wrapper">
                        ...
                        <div class="mb-12 flex flex-wrap justify-between lg:mb-0">
                            <div class="mb-8 flex w-[330px] max-w-full">
                                ...
                                <div>
                                    <h5 class="mb-6 text-lg font-semibold">Nuestra localización</h5>
                                    <a href="https://g.page/elcibernarium?share">
                                        <p class="text-base text-body-color  hover:text-primary">
                                            Carrer de Roc Boronat, 117, 127, 08018 Barcelona
                                        </p>
                                    </a>
                                </div>
                            </div>
                            <div class="mb-8 flex w-[330px] max-w-full">
                                ...
                                <div>
                                    ...
                                    <p class="text-base text-body-color  hover:text-primary">info@3KLeague.com</p>
                                    <p class="text-base text-body-color  hover:text-primary">
                                        contact@3KLeague.com
                                    </p>
                                </div>
                            </div>
                        </div>
              ...
              ">
                        ...
                        <form>
                            <div class="mb-6">
                                <label for="fullName" class="block text-xs text-dark">Nombre y Apellido*</label>
                            ...
                            <div class="mb-6">
                                <label for="email" class="block text-xs text-dark">Correo electrónico*</label>
                                <input type="email" name="email" placeholder="ejemplo@yourmail.com"
                                    class="w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-primary focus:outline-none" />
                            </div>
                            <div class="mb-6">
                                <label for="phone" class="block text-xs text-dark">Móvil*</label>
                                <input type="text" name="phone" placeholder="+34 654 511 552"
                                    class="w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-primary focus:outline-none" />
                            </div>
                            <div class="mb-6">
                                <label for="message" class="block text-xs text-dark">Mensaje*</label>
                                <textarea name="message" rows="1" placeholder="Escribe tu comentario aquí..."
