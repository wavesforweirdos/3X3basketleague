...
@section('content')
    ...
    <div class="w-full px-4 lg:w-4/12">
        <div>
            <div class="wow fadeInUp relative mb-12 overflow-hidden rounded bg-primary py-[60px] px-11 text-center lg:px-8"
                data-wow-delay=".1s">
                <h3 class="mb-2 text-2xl font-semibold text-white">
                    Join the league!
                </h3>
                <p class="mb-8 text-base text-white">
                    Registration open for <strong>{{ $entity->name }}</strong> league. You must register
                    previously in
                    the private area.
                </p>
                <div
                ...
                <p class="text-sm font-medium text-white">
                    Oh no! Not a member yet?
                    <a href="signup.html" class="text-secondary-900 hover:underline">
                        Sign Up
                    </a>
                </p>
