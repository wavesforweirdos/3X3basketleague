    ...
    <div class="border-t border-opacity-10 border-gray-700">
        <div class="container">
            <div class="w-full grid grid-cols-3 grid-rows-3 gap-2 justify-center items-center">
                <div class="col-span-3 md:col-span-2 w-full flex flex-col md:flex-row gap-x-4 items-center justify-start  text-[#f3f4fe]">
                ...
                <div class="col-span-3 md:col-span-1 w-full">
                    <div class="-mx-3 flex justify-center md:justify-end items-center">
                ...
                <div class="pt-4 col-span-3 md:col-span-2 w-full justify-center md:justify-start items-center">
                    <p class="text-base text-left text-[#f3f4fe]">
            ...
            {{-- <div class="w-full grid grid-cols-3 grid-rows-3 gap-2 justify-center items-center">
                <div class="col-span-2 w-full flex gap-x-4 items-center justify-start  text-[#f3f4fe]">
                    <a href="javascript:void(0)" class="text-sm hover:text-primary">
                        Política de Privacidad
                    </a>
                    <a href="javascript:void(0)" class="text-sm hover:text-primary">
                ...
                <div class="col-span-2 w-full justify-start items-center">
                    <p class="text-base text-[#f3f4fe] text-left mb-4">
                        Creamos experiencias digitales para marcas y empresas deportivas.
                    </p>
                </div>
                <div class="col-span-1 w-full justify-end items-center">
                    <p class="text-base text-right text-[#f3f4fe]">
                        Diseñado y Desarrollado por
                        <a href="https://wavesforweirdos.com" rel="nofollow noopner" target="_blank"
                            class="text-primary hover:underline">
        ...
        <div>
            <span class="absolute top-0 right-0 z-[-1]">
                @php
                    $figure = '<svg width="102" height="102" viewBox="0 0 102 102" fill="none"
                    xmlns="http://www.w3.org/2000/svg">';
                    for ($j = 1; $j < 250; $j += 15) {
                        for ($i = 1; $i < 200; $i += 15) {
                            $figure .= '<circle cx="' . $j . '" cy="' . $i . '" r="1.5" transform="rotate(-90 1.66667 104)" fill="white" fill-opacity="0.08" />';
                        }
                    }
                    $figure .= '</svg>';
                    echo $figure;
